...
def generate_launch_description():
    ...
    declare_robot_name      = DeclareLaunchArgument('robot_name', default_value='robot_deadaeef')
    ...
    setup_cmd = IncludeLaunchDescription(
        ...
        #FrontendLaunchDescriptionSource(os.path.join(pkg_share, 'launch', 'basic.launch.xml')),
    )
